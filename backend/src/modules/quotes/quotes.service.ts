...
.header-left{width:50%;background:#ffffff;padding:25px 30px;position:relative;display:flex;align-items:center;justify-content:center}
.header-right{flex:1;background:linear-gradient(135deg,#03172B 0%,#062440 100%);padding:20px 30px;display:flex;flex-direction:column;justify-content:center;position:relative;clip-path:polygon(15% 0,100% 0,100% 100%,0 100%)}
...
.slogan{display:none}
.quote-title{font-size:32px;font-weight:800;color:#ffffff;letter-spacing:-1px;position:relative;text-align:right}
.quote-title-line{width:60px;height:3px;background:linear-gradient(90deg,#54B7FF,#168BFF);border-radius:2px;margin-top:6px;position:relative;margin-left:auto}
...
.info-grid{margin-top:14px;font-size:11px;position:relative;padding-left:30px}
